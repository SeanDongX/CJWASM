...
| 13 WASM 互操作 | @import, @export, foreign func | WASI(fd_write/fd_read/fd_close/args_get/clock_time_get/random_get) |
...
*文档版本: 10.0.0*
*最后更新: 2026-02-14（Phase 10 完成，cjc release/1.0 语法对齐；基于 spec.md v3.0.0）*
