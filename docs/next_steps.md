...
*文档版本: 10.6.0*
*最后更新: 2026-02-15（P2 核心语法扩展部分完成：static 成员、抽象方法、for-in 步长、动态 Array 构造、Array 实例方法(clone/isEmpty/slice)、命名参数(name!:)、String 方法(trim/startsWith/endsWith/contains/indexOf/split/replace/isEmpty/isBlank)；修复 sort() 哑值推入 bug、inheritance.cj 预期值修正）*
